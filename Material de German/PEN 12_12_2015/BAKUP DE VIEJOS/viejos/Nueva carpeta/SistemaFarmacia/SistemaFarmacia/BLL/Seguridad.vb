...
Public Class Seguridad
    ...
    Public Function ValidarServidor(ByVal Servidor As String) As Boolean
        Dim ConnectionString = "Data Source=" + Servidor + ";Initial Catalog=AlmFierros;Integrated Security=True"
        Dim SqlConn As New SqlClient.SqlConnection With {.ConnectionString = ConnectionString}
        Try
            SqlConn.Open()
            SqlConn.Close()
            Return True
