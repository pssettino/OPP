    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        If Validar() Then
            ...
            If _id = 0 Then
                ...
                MessageBox.Show("Se Registro el Cliente: " & dni, "Registrar Cliente", MessageBoxButtons.OK, MessageBoxIcon.Information)
                RegistrarBitacora("Registro Cliente: " & dni, "Alta")
            Else
                unCliente.clienteId = _id
                BLL.Cliente.GetInstance.Update(unCliente)
                MessageBox.Show("Se Modifico el Cliente: " & dni, "Modificar Cliente", MessageBoxButtons.OK, MessageBoxIcon.Information)
