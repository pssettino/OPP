...
Public Class DVH
    ...
    Public Function GetTablas() As DataSet
        ...
        tablas.Add(New Tabla With {.nombre = "Usuario_Patente", .primary_keys = {"usuario_id", "patente_id"}})
        ...
        tablas.Add(New Tabla With {.nombre = "Venta_Medicamento", .primary_keys = {"venta_id", "medicamento_id"}})
