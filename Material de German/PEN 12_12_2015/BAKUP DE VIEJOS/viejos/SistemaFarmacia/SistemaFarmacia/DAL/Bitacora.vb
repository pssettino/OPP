...
Public Class Bitacora
    ...
    Public Function RegistrarBitacora(objAdd As BE.Bitacora) As Boolean
        ...
        criticidad_desc.ParameterName = "@criticidad_desc"
        criticidad_desc.Value = objAdd.criticidad.nombre
    ...
    Public Function ListarBitacoraPorId(objId As BE.Bitacora) As BE.Bitacora
        ...
        Try
            ...
            For Each fila As DataRow In ds.Tables(0).Rows
                ...
                CriticidadBE.criticidad_fk = CInt(fila("criticidad_fk"))
    ...
    Public Function ListarBitacoraPorParametros(usuario_id As Integer, fechaDesde As DateTime, fechaHasta As DateTime, criticidad As Integer) As List(Of BE.Bitacora)
        Dim comm As New SqlClient.SqlCommand
        Dim sqlDa As New SqlClient.SqlDataAdapter
        Dim returnValue As Boolean = False
        Dim ds As New DataSet
        ...
        criticidad_desc.DbType = DbType.Int16
        ...
        Try
            ...
            For Each fila As DataRow In ds.Tables(0).Rows
                ...
                BitacoraBE.descripcion = CStr(fila("descripcion"))
                BitacoraBE.fecha = CDate(fila("fecha_hora"))
                CriticidadBE.criticidad_fk = CInt(fila("criticidad_id"))
                CriticidadBE.nombre = CStr(fila("nivel"))
                BitacoraBE.criticidad = CriticidadBE
