...
Public Class Medicamento
    ...
    Public Function ObtenerMedicamentoPorReceta(check As Boolean) As List(Of BE.Medicamento)
        Try
            Return DAL.Medicamento.GetInstance.ObtenerMedicamentoPorReceta(check)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
