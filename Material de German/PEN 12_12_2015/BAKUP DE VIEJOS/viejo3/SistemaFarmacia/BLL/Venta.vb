...
Public Class Venta
    ...
    Public Function ModificarVenta(objAdd As BE.Venta) As Boolean
        Try
            If DAL.Venta.GetInstance().RegistrarVenta(objAdd) Then
                GenerarDV(ObtenerMaxId())
                Return True
    ...
    Public Function ListarVentasById(VentaBE As BE.Venta) As BE.Venta
        Try
            Return DAL.Venta.GetInstance().ListarVentasById(VentaBE)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Sub GenerarDV(Optional ByVal Id As Integer = 0)
        ...
        Venta.ventaId = Id
        If Id > 0 Then
            Dim VentaBE = DAL.Venta.GetInstance.ListarVentasById(Venta)
