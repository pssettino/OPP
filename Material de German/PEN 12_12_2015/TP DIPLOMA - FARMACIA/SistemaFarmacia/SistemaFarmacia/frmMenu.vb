Public Class frmMenu
    ...
    Public Sub ValidarMenu()
        ...
        If BLL.Usuario.GetInstance.VerificarPatente(UsuarioBE, PatenteBE) Then
            ...
            ReporteStockDeMedicamentosToolStripMenuItem.Enabled = True
        End If
    ...
    Private Sub ReporteStockDeMedicamentosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ReporteStockDeMedicamentosToolStripMenuItem.Click
        UI.frmMedicamentosReporteFiltro.MdiParent = Me
        UI.frmMedicamentosReporteFiltro.Show()
    End Sub
End Class
